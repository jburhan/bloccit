...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  describe "POST create" do
    ...
    it "assigns the new sponsored post to @sponsored_post" do
      post :create, params: { topic_id: my_topic.id, sponsored_post: { title: RandomData.random_sentence, body: RandomData.random_paragraph, post: RandomData.random_number} }
